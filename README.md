...
- [tweag/codeql-wrapper](https://github.com/tweag/codeql-wrapper) - A universal Python CLI wrapper for running CodeQL analysis seamlessly across any project architecture and CI/CD platform
